...
module.exports = class ProcGroup {
  ...
  getClass() {
    ...
    for (var procedure of this.procedures) {
      ...
      switch (outParams.length) {
        case 0:
          lines.push('    return results; //No output parameters?');
          break;
        case 1:
          lines.push(`    return results.parameters; //Single output parameter`);
          break;
        default:
          lines.push('    return results; //Multiple output parameters');
      }
