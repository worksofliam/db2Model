...
module.exports = class Table {
  ...
  async getClass() {
    ...
    var method = '', comment = '', value = '', jsType;
    ...
    for (var ref of refs) {
      lines.push(
        ...
        `  * @returns {${prty(ref.refersTo.table)}}`,
        `  */`,
    ...
    lines.push(
      `  /**`,
      `  * Fetchs an array of ${this.getPrettyName()} by clauses provided.`,
      ...
      `  * @returns {${this.getPrettyName()}[]} Returns an array of ${this.getPrettyName()}.`,
      `  */`,
