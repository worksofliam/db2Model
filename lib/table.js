...
module.exports = class Table {
  ...
  async getClass() {
    ...
    for (var column of this.columns) {
      ...
      lines.push(`    this.${column.columnName.toLowerCase()} = row.${column.columnName}; ${comment}`);

      if (column.isNullable) 
        if (method !== '') {
          lines.push(`    if (this.${column.columnName.toLowerCase()})`);
          lines.push(`      this.${column.columnName.toLowerCase()} = this.${column.columnName.toLowerCase()}${method};`);
        }
